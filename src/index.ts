...
while (cantidadElegida < 1) {
  cantidadElegida = Number(
    prompt("No puede adquirir una cantidad inferior a 1, ingrese otra cantidad")
  );
}
...
if (productoElegido === 1 && stockProducto1 > 0) {
  console.log(
    ...
    ". Gracias por su compra, vuelva a visitarnos"
  );
  console.log(
    "Quedan",
  ...
  console.log(
    ...
    ". Gracias por su compra, vuelva a visistarnos"
  );
